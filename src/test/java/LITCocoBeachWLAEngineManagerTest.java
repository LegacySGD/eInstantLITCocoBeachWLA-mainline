...
public class LITCocoBeachWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITCocoBeachWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITCocoBeachWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITCocoBeachWLAIW/InitOutcome.xml").getDocumentElement();
